...
type V0040JobTime struct {
	...
	System *V0039JobTimeSystem `json:"system,omitempty"`
	Limit *V0040Uint32NoVal `json:"limit,omitempty"`
	Total *V0039JobTimeSystem `json:"total,omitempty"`
	User *V0039JobTimeSystem `json:"user,omitempty"`
}
...
// SetSystem gets a reference to the given V0039JobTimeSystem and assigns it to the System field.
...
// SetTotal gets a reference to the given V0039JobTimeSystem and assigns it to the Total field.
...
// SetUser gets a reference to the given V0039JobTimeSystem and assigns it to the User field.
