...
type V0040Job struct {
	...
	Comment *V0039JobComment `json:"comment,omitempty"`
	...
	Mcs *V0039JobMcs `json:"mcs,omitempty"`
	...
	Reservation *V0039JobReservation `json:"reservation,omitempty"`
...
// SetComment gets a reference to the given V0039JobComment and assigns it to the Comment field.
...
// SetMcs gets a reference to the given V0039JobMcs and assigns it to the Mcs field.
...
// SetReservation gets a reference to the given V0039JobReservation and assigns it to the Reservation field.
