...
// checks if the V0039RollupStatsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0039RollupStatsInner{}

// V0039RollupStatsInner recorded rollup statistics
type V0039RollupStatsInner struct {
	// type
...
func (o V0039RollupStatsInner) MarshalJSON() ([]byte, error) {
...
func (o V0039RollupStatsInner) ToMap() (map[string]interface{}, error) {
...
type NullableV0039RollupStatsInner struct {
	value *V0039RollupStatsInner
	isSet bool
}
...
func NewNullableV0039RollupStatsInner(val *V0039RollupStatsInner) *NullableV0039RollupStatsInner {
	return &NullableV0039RollupStatsInner{value: val, isSet: true}
}
