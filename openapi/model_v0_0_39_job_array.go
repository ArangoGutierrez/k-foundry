...
type V0039JobArray struct {
	...
	Limits *V0039JobArrayLimits `json:"limits,omitempty"`
...
// SetLimits gets a reference to the given V0039JobArrayLimits and assigns it to the Limits field.
