...
func (o *V0039Tres) UnmarshalJSON(data []byte) (err error) {
	...
	varV0039Tres := _V0039Tres{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0039Tres)

	if err != nil {
		return err
	}

	*o = V0039Tres(varV0039Tres)
