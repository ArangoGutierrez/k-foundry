...
type V0039StepStatistics struct {
	CPU *V0039StepStatisticsCPU `json:"CPU,omitempty"`
...
func (o *V0039StepStatistics) GetCPU() V0039StepStatisticsCPU {
	if o == nil || IsNil(o.CPU) {
		var ret V0039StepStatisticsCPU
		return ret
	}
	return *o.CPU
}
...
// SetCPU gets a reference to the given V0039StepStatisticsCPU and assigns it to the CPU field.
