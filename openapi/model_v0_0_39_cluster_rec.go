...
type V0039ClusterRec struct {
	Controller *V0039ClusterRecController `json:"controller,omitempty"`
...
func (o *V0039ClusterRec) GetController() V0039ClusterRecController {
	if o == nil || IsNil(o.Controller) {
		var ret V0039ClusterRecController
		return ret
	}
	return *o.Controller
}
...
// SetController gets a reference to the given V0039ClusterRecController and assigns it to the Controller field.
func (o *V0039ClusterRec) SetController(v V0039ClusterRecController) {
	o.Controller = &v
}
