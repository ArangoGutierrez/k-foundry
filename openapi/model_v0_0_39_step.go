...
type V0039Step struct {
	...
	Tasks *V0039StepTasks `json:"tasks,omitempty"`
	...
	Task *V0039StepTask `json:"task,omitempty"`
...
// SetTasks gets a reference to the given V0039StepTasks and assigns it to the Tasks field.
...
// SetTask gets a reference to the given V0039StepTask and assigns it to the Task field.
