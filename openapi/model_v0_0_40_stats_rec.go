...
type V0040StatsRec struct {
	...
	Rollups []V0039RollupStatsInner `json:"rollups,omitempty"`
...
// SetRollups gets a reference to the given []V0039RollupStatsInner and assigns it to the Rollups field.
