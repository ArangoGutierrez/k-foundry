...
type V0040StepTime struct {
	...
	System *V0039StepTimeSystem `json:"system,omitempty"`
	Total *V0039StepTimeSystem `json:"total,omitempty"`
	User *V0039StepTimeSystem `json:"user,omitempty"`
}
...
// SetSystem gets a reference to the given V0039StepTimeSystem and assigns it to the System field.
...
// SetTotal gets a reference to the given V0039StepTimeSystem and assigns it to the Total field.
...
// SetUser gets a reference to the given V0039StepTimeSystem and assigns it to the User field.
